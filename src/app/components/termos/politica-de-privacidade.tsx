    ...
    return(
        <main>
            <h1>POLÍTICA DE PRIVACIDADE</h1>
                <p>A sua privacidade é importante para nós. É política do site Controller Solar respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Controller Solar, e outros sites que possuímos e operamos.</p>
                ...
                <p>Fica, desde já, o titular de dados ciente que o conteúdo desta Política de Privacidade pode ser alterado a critério do site Controller Solar, independente de aviso ou notificação. Em caso de alteração, as modificações produzem todos os efeitos a partir do momento da disponibilização no site.</p>
                <p>O site Controller Solar não se responsabiliza caso você venha utilizar seus dados de forma incorreta ou inverídica, ficando excluído de qualquer responsabilidade neste sentido.</p>
...
Para mais informações sobre cookies do Google Analytics, consulte a página oficial do Google Analytics.</li>
            ...
            <h2>Compromisso do Usuário</h2>
                <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o site Controller Solar oferece e com caráter enunciativo, mas não limitativo:</p>
                    <ol>
                        ...
                        <li>Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do site Controller Solar, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados;</li>
            ...
            <h2>Direitos do titular de dados</h2>
                <p>O titular de dados pessoais possui o direito de solicitar do site Controller Solar, através do canal específico de tratamento, a qualquer momento, mediante requisição formal, informações referentes aos seus dados.</p>
            ...
            <h2>Como exercer os seus direitos de titular de dados?</h2>
                <p>Para as demais solicitações em relação aos direitos do titular de dados pessoais, entre em contato conosco;</p>
